      ...
      <div className="relative w-full h-screen grid grid-cols-1 lg:grid-cols-2 place-content-center place-items-center">
        <div className="container">
          <div>
            ...
            <p className="text-[20px] text-irish-coffee pt-3 pb-10 leading-[200%] font-normal">Don't have an account? <Link href="/signup"><span className="text-sky-500">Sign up</span></Link></p>
          </div>
