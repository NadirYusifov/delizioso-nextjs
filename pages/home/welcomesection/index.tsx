      ...
      <div className="welcome-wrapper grid grid-cols-1 lg:grid-cols-2 place-items-center">
        ...
        <div className="container mx-auto px-4 order-1">
          <div className="welcome-text">
            <h3 className="text-[3.75rem] text-dark-coffee lg:text-[5rem] leading-[110.1%] font-bold font-tinos">
              Welcome to <span className="text-dark-orange">delizioso</span>
            </h3>
            <p className="w-full lg:w-[433.11px] text-deep-walnut text-[20px] font-normal font-popins leading-[200%] pt-15 pb-20">
