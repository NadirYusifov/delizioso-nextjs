    ...
    <section>
      <div className="container">
        <div className="contact-us-header text-center">
          <h3 className="text-medium-roast text-[30px] lg:text-[80px] font-bold leading-[100%] pb-4 lg:pb-9">
            Contact us
          </h3>
          <p className="text-irish-coffee text-[18px] lg:text-[25px] font-normal leading-[100%]">
        ...
        <div className="contact-us-form my-10">
          <form className="space-y-4" onSubmit={formik.handleSubmit}>
            ...
            <Button
              type="submit"
              className="w-full bg-dark-orange text-white rounded-lg py-3"
            >
              Submit
            </Button>
          </form>
