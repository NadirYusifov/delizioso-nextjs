                    ...
                    if (type === "start-ellipsis" || type === 'end-ellipsis') {
                        ...
                        children = (
                            ...
                            className='bg-dark-orange/30 px-4 py-2 mx-2 rounded-lg text-dark-orange'
                                ...
                                {...data}
                                onClick={(event: React.MouseEvent<HTMLButtonElement>) => handlePagination(page)}
                            >
                                {page}
                                {children}
                            </button>
                        ...
                        children = (
                            <ArrowButton className='bg-medium-roast text-white py-3 px-3 mx-5 rounded-lg' type="button" {...data}>
                                {type}
                                {}
                            </ArrowButton>
                        );
